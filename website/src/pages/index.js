...
function getAssignmentState(item) {
  ...
  const release =
    item.releaseDate ? new Date(`${item.releaseDate}T00:00:00`) : null
...
function AssignmentPanel() {
  ...
  return (
    <section
      ...
      aria-label="Current assignments">
        ...
        <div className={styles.assignmentsPanel}>
          ...
          {items.length === 0 ?
            <p className={styles.emptyState}>
              No homework assignments have been assigned at this time.
            </p>
                  ...
                  <div className={styles.assignmentTopRow}>
                    ...
                    <span
                      className={clsx(
                        ...
                        getAssignmentState(item) === 'Current' &&
                          styles.stateCurrent,
                        getAssignmentState(item) === 'Upcoming' &&
                          styles.stateUpcoming,
                        getAssignmentState(item) === 'Closed' &&
                          styles.stateClosed,
                      )}>
